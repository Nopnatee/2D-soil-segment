...
def get_training_augmentation(img_size=512):
    ...
    train_transform = A.Compose([
        # Resize shortest side to img_size * 2, maintaining aspect ratio
        ...
        # Optional: Further rotation if SquareSymmetry isn't sufficient
...
def main():
    ...
    # Training follows the Jupyter "Training Sequence" (no visualization)
    # print("Visualizing augmentations...")
    # visualize_augmentations(train_loader.dataset.dataset, num_samples=3)
    ...
    # Visualization disabled to match notebook Training Sequence
    # print("\nVisualizing predictions...")
    # visualize_predictions(model, test_loader.dataset.dataset, device, num_samples=5)
